...
import { getTodoBridge, type TodoBridge, type TodoList, type ListDetail } from '@app/bridge/lib/bridges/todo-bridge'
    ...
    <div className="max-w-2xl mx-auto p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Bridge CRUD demo — create, read, update, delete via C++ backend.</CardDescription>
        </CardHeader>
